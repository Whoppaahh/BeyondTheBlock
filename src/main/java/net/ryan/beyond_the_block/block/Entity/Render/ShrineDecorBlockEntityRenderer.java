...
public class ShrineDecorBlockEntityRenderer implements BlockEntityRenderer<ShrineDecorBlockEntity> {

    public ShrineDecorBlockEntityRenderer(BlockEntityRendererFactory.Context context) {}


    @Override
    public void render(ShrineDecorBlockEntity entity, float tickDelta, MatrixStack matrices,
