...
public class SingleInputBlockEntityRenderer implements BlockEntityRenderer<SingleInputBlockEntity> {

    public SingleInputBlockEntityRenderer(BlockEntityRendererFactory.Context context) {}


    @Override
    public void render(SingleInputBlockEntity entity, float tickDelta, MatrixStack matrices,
