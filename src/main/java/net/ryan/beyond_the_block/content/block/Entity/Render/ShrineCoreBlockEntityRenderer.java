...
import net.ryan.beyond_the_block.content.block.Entity.ShrineEntity.ShrineCoreBlockEntity;

import java.util.Objects;

public class ShrineCoreBlockEntityRenderer implements BlockEntityRenderer<ShrineCoreBlockEntity> {


    public ShrineCoreBlockEntityRenderer(BlockEntityRendererFactory.Context context) {}

    @Override
    public void render(ShrineCoreBlockEntity entity, float tickDelta, MatrixStack matrices,
