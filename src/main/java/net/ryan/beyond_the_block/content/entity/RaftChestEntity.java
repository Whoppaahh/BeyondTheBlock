...
public class RaftChestEntity extends ChestBoatEntity {
    private static final TrackedData<Integer> VARIANT =
            DataTracker.registerData(RaftChestEntity.class, TrackedDataHandlerRegistry.INTEGER);

    public RaftChestEntity(EntityType<? extends ChestBoatEntity> type, World world) {
        super(type, world);
    }

    public RaftChestEntity(World world, double x, double y, double z) {
        this(ModEntities.MOD_CHEST_RAFT, world);
    ...
    @Override
    public Item asItem() {
        return ModItems.BAMBOO_CHEST_RAFT;
    }
