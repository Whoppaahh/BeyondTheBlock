...
public class RangedBowAttackPassiveGoal<T extends GuardEntity & RangedAttackMob> extends Goal {
    ...
    public void tick() {
        ...
        if (livingentity != null) {
            double distance = this.entity.squaredDistanceTo(livingentity.getX(), livingentity.getY(), livingentity.getZ());
            boolean canSee = this.entity.getVisibilityCache().canSee(livingentity);
