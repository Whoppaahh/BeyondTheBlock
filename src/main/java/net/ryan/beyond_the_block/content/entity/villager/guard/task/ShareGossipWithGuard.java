package net.ryan.beyond_the_block.content.entity.villager.guard.task;
...
public class ShareGossipWithGuard extends Task<VillagerEntity> {
    ...
    protected boolean shouldRun(ServerWorld serverWorld, VillagerEntity villagerEntity) {
        return LookTargetUtil.canSee(villagerEntity.getBrain(), MemoryModuleType.INTERACTION_TARGET, GUARD_VILLAGER);
    }
