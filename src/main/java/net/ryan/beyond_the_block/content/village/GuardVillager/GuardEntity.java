package net.ryan.beyond_the_block.content.village.GuardVillager;
        ...
        if (damage >= 0.0F) {
            ...
            for (int i = 0; i < this.guardInventory.size(); ++i) {
                ...
                if ((!damageSource.isFire() || !itemstack.getItem().isFireproof()) && itemstack.getItem() instanceof ArmorItem) {
                    int j = i;
                    itemstack.damage((int) damage, this, (guard) -> {
                        guard.sendEquipmentBreakStatus(EquipmentSlot.fromTypeIndex(EquipmentSlot.Type.ARMOR, j));
                    });
                }
            }
        }
