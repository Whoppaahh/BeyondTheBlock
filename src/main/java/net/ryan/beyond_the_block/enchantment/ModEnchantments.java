...
import net.ryan.beyond_the_block.enchantment.Armour.WardingGlyphEnchantment;
import net.ryan.beyond_the_block.enchantment.Armour.boots.GroundedResistanceEnchantment;
import net.ryan.beyond_the_block.enchantment.Armour.boots.LeapOfFaithEnchantment;
import net.ryan.beyond_the_block.enchantment.Armour.boots.SilentStepsEnchantment;
import net.ryan.beyond_the_block.enchantment.Armour.chestplates.DurabilityBoostEnchantment;
import net.ryan.beyond_the_block.enchantment.Armour.chestplates.EchoGuardEnchantment;
...
import net.ryan.beyond_the_block.enchantment.Armour.helmets.RadiantAuraEnchantment;
...
import net.ryan.beyond_the_block.enchantment.Tools.hoes.DeepTillEnchantment;
import net.ryan.beyond_the_block.enchantment.Tools.hoes.GardensBountyEnchantment;
import net.ryan.beyond_the_block.enchantment.Tools.pickaxes.ShadowMiningEnchantment;
import net.ryan.beyond_the_block.enchantment.Tools.pickaxes.SmeltingStrikeEnchantment;
import net.ryan.beyond_the_block.enchantment.Tools.pickaxes.StonebreakerEnchantment;
import net.ryan.beyond_the_block.enchantment.Tools.shovels.DarkDigEnchantment;
import net.ryan.beyond_the_block.enchantment.Tools.shovels.EarthShatterEnchantment;
import net.ryan.beyond_the_block.enchantment.Tools.shovels.FertilityEnchantment;
import net.ryan.beyond_the_block.enchantment.Tools.swords.*;
