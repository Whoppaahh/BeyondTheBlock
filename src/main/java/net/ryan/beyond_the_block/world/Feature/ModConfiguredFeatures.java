package net.ryan.beyond_the_block.world.Feature;
...
public class ModConfiguredFeatures {
    ...
    public static final RegistryEntry<ConfiguredFeature<OreFeatureConfig, ?>> XP_ORE =
            ConfiguredFeatures.register("xp_ore", Feature.ORE, new OreFeatureConfig(OVERWORLD_XP_ORES, AutoConfig.getConfigHolder(ModConfig.class).getConfig().ores.xpOre));
    public static final RegistryEntry<ConfiguredFeature<OreFeatureConfig, ?>> NETHER_XP_ORE =
            ConfiguredFeatures.register("nether_xp_ore",Feature.ORE, new OreFeatureConfig(NETHER_XP_ORES, AutoConfig.getConfigHolder(ModConfig.class).getConfig().ores.xpOre));
    public static final RegistryEntry<ConfiguredFeature<OreFeatureConfig, ?>> END_XP_ORE =
            ConfiguredFeatures.register("end_xp_ore",Feature.ORE, new OreFeatureConfig(END_XP_ORES, AutoConfig.getConfigHolder(ModConfig.class).getConfig().ores.xpOre));
    //endregion
    //region Ruby
    ...
    public static final RegistryEntry<ConfiguredFeature<OreFeatureConfig, ?>> RUBY_ORE =
            ConfiguredFeatures.register("ruby_ore", Feature.ORE, new OreFeatureConfig(OVERWORLD_RUBY_ORES, AutoConfig.getConfigHolder(ModConfig.class).getConfig().ores.rubyOre));
//endregion
    //region Miranite
    ...
    public static final RegistryEntry<ConfiguredFeature<OreFeatureConfig, ?>> MIRANITE_ORE =
            ConfiguredFeatures.register("miranite_ore", Feature.ORE, new OreFeatureConfig(OVERWORLD_MIRANITE_ORES, AutoConfig.getConfigHolder(ModConfig.class).getConfig().ores.miraniteOre));
    public static final RegistryEntry<ConfiguredFeature<OreFeatureConfig, ?>> NETHER_MIRANITE_ORE =
            ConfiguredFeatures.register("nether_miranite_ore",Feature.ORE, new OreFeatureConfig(NETHER_MIRANITE_ORES, AutoConfig.getConfigHolder(ModConfig.class).getConfig().ores.miraniteOre));
    public static final RegistryEntry<ConfiguredFeature<OreFeatureConfig, ?>> END_MIRANITE_ORE =
            ConfiguredFeatures.register("end_miranite_ore",Feature.ORE, new OreFeatureConfig(END_MIRANITE_ORES, AutoConfig.getConfigHolder(ModConfig.class).getConfig().ores.miraniteOre));
    //endregion
    //region Chromite
    ...
    public static final RegistryEntry<ConfiguredFeature<OreFeatureConfig, ?>> CHROMITE_ORE =
            ConfiguredFeatures.register("chromite_ore", Feature.ORE, new OreFeatureConfig(OVERWORLD_CHROMITE_ORES, AutoConfig.getConfigHolder(ModConfig.class).getConfig().ores.chromiteOre));
    public static final RegistryEntry<ConfiguredFeature<OreFeatureConfig, ?>> NETHER_CHROMITE_ORE =
            ConfiguredFeatures.register("nether_chromite_ore",Feature.ORE, new OreFeatureConfig(NETHER_CHROMITE_ORES, AutoConfig.getConfigHolder(ModConfig.class).getConfig().ores.chromiteOre));
    public static final RegistryEntry<ConfiguredFeature<OreFeatureConfig, ?>> END_CHROMITE_ORE =
            ConfiguredFeatures.register("end_chromite_ore",Feature.ORE, new OreFeatureConfig(END_CHROMITE_ORES, AutoConfig.getConfigHolder(ModConfig.class).getConfig().ores.chromiteOre));
    //endregion
    //region Nocturnite
    ...
    public static final RegistryEntry<ConfiguredFeature<OreFeatureConfig, ?>> NOCTURNITE_ORE =
            ConfiguredFeatures.register("nocturnite_ore", Feature.ORE, new OreFeatureConfig(OVERWORLD_NOCTURNITE_ORES, AutoConfig.getConfigHolder(ModConfig.class).getConfig().ores.nocturniteOre));
    public static final RegistryEntry<ConfiguredFeature<OreFeatureConfig, ?>> NETHER_NOCTURNITE_ORE =
            ConfiguredFeatures.register("nether_nocturnite_ore",Feature.ORE, new OreFeatureConfig(NETHER_NOCTURNITE_ORES, AutoConfig.getConfigHolder(ModConfig.class).getConfig().ores.nocturniteOre));
    public static final RegistryEntry<ConfiguredFeature<OreFeatureConfig, ?>> END_NOCTURNITE_ORE =
            ConfiguredFeatures.register("end_nocturnite_ore",Feature.ORE, new OreFeatureConfig(END_NOCTURNITE_ORES, AutoConfig.getConfigHolder(ModConfig.class).getConfig().ores.nocturniteOre));
    //endregion
    //region Amberine
    ...
    public static final RegistryEntry<ConfiguredFeature<OreFeatureConfig, ?>> AMBERINE_ORE =
            ConfiguredFeatures.register("amberine_ore", Feature.ORE, new OreFeatureConfig(OVERWORLD_AMBERINE_ORES, AutoConfig.getConfigHolder(ModConfig.class).getConfig().ores.amberineOre));
    //endregion
    //region Rosette
    ...
    public static final RegistryEntry<ConfiguredFeature<OreFeatureConfig, ?>> ROSETTE_ORE =
            ConfiguredFeatures.register("rosette_ore", Feature.ORE, new OreFeatureConfig(OVERWORLD_ROSETTE_ORES, AutoConfig.getConfigHolder(ModConfig.class).getConfig().ores.rosetteOre));
    public static final RegistryEntry<ConfiguredFeature<OreFeatureConfig, ?>> NETHER_ROSETTE_ORE =
            ConfiguredFeatures.register("nether_rosette_ore",Feature.ORE, new OreFeatureConfig(NETHER_ROSETTE_ORES, AutoConfig.getConfigHolder(ModConfig.class).getConfig().ores.rosetteOre));
    public static final RegistryEntry<ConfiguredFeature<OreFeatureConfig, ?>> END_ROSETTE_ORE =
            ConfiguredFeatures.register("end_rosette_ore",Feature.ORE, new OreFeatureConfig(END_ROSETTE_ORES, AutoConfig.getConfigHolder(ModConfig.class).getConfig().ores.rosetteOre));
    //endregion
    //region Azuros
    ...
    public static final RegistryEntry<ConfiguredFeature<OreFeatureConfig, ?>> AZUROS_ORE =
            ConfiguredFeatures.register("azuros_ore", Feature.ORE, new OreFeatureConfig(OVERWORLD_AZUROS_ORES, AutoConfig.getConfigHolder(ModConfig.class).getConfig().ores.azurosOre));
    public static final RegistryEntry<ConfiguredFeature<OreFeatureConfig, ?>> NETHER_AZUROS_ORE =
            ConfiguredFeatures.register("nether_azuros_ore",Feature.ORE, new OreFeatureConfig(NETHER_AZUROS_ORES, AutoConfig.getConfigHolder(ModConfig.class).getConfig().ores.azurosOre));
    public static final RegistryEntry<ConfiguredFeature<OreFeatureConfig, ?>> END_AZUROS_ORE =
            ConfiguredFeatures.register("end_azuros_ore",Feature.ORE, new OreFeatureConfig(END_AZUROS_ORES, AutoConfig.getConfigHolder(ModConfig.class).getConfig().ores.azurosOre));
    //endregion
    //region Indigra
    ...
    public static final RegistryEntry<ConfiguredFeature<OreFeatureConfig, ?>> INDIGRA_ORE =
            ConfiguredFeatures.register("indigra_ore", Feature.ORE, new OreFeatureConfig(OVERWORLD_INDIGRA_ORES, AutoConfig.getConfigHolder(ModConfig.class).getConfig().ores.indigraOre));
    public static final RegistryEntry<ConfiguredFeature<OreFeatureConfig, ?>> NETHER_INDIGRA_ORE =
            ConfiguredFeatures.register("nether_indigra_ore",Feature.ORE, new OreFeatureConfig(NETHER_INDIGRA_ORES, AutoConfig.getConfigHolder(ModConfig.class).getConfig().ores.indigraOre));
    public static final RegistryEntry<ConfiguredFeature<OreFeatureConfig, ?>> END_INDIGRA_ORE =
            ConfiguredFeatures.register("end_indigra_ore",Feature.ORE, new OreFeatureConfig(END_INDIGRA_ORES, AutoConfig.getConfigHolder(ModConfig.class).getConfig().ores.indigraOre));
    //endregion
    //region Xirion
    ...
    public static final RegistryEntry<ConfiguredFeature<OreFeatureConfig, ?>> XIRION_ORE =
            ConfiguredFeatures.register("xirion_ore", Feature.ORE, new OreFeatureConfig(OVERWORLD_XIRION_ORES, AutoConfig.getConfigHolder(ModConfig.class).getConfig().ores.xirionOre));
    public static final RegistryEntry<ConfiguredFeature<OreFeatureConfig, ?>> NETHER_XIRION_ORE =
            ConfiguredFeatures.register("nether_xirion_ore",Feature.ORE, new OreFeatureConfig(NETHER_XIRION_ORES, AutoConfig.getConfigHolder(ModConfig.class).getConfig().ores.xirionOre));
    public static final RegistryEntry<ConfiguredFeature<OreFeatureConfig, ?>> END_XIRION_ORE =
            ConfiguredFeatures.register("end_xirion_ore",Feature.ORE, new OreFeatureConfig(END_XIRION_ORES, AutoConfig.getConfigHolder(ModConfig.class).getConfig().ores.xirionOre));
    //endregion
